...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="rtc./easyrtc/easyrtc.css" />
    ...
    <body onload="connect()">
        ...
        <div id="container">
            ...
            <!--removed the header stuff, reinsert if necessary -->
            <div id="main">

                <!-- Main Content -->
                <h1>WEBRTC Demo: Instant Messaging</h1>
                <p>This application demonstrates text messaging using the WEBRTC technology!
                    <h3> It connects to the server upon start up, and display buttons for the other
                    peers running the same application.
                    </h3>
                </p>
